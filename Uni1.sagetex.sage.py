...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_10p0 = RealNumber('10.0'); _sage_const_19 = Integer(19); _sage_const_21 = Integer(21); _sage_const_20 = Integer(20)## This file (Uni1.sagetex.sage) was *autogenerated* from Uni1.tex with sagetex.sty version 2012/01/16 v2.3.3-69dcb0eb93de.
import sagetex
...
try:
 from sympy import *
 x=symbols('x')
 Rango=range(_sage_const_5 )+range(_sage_const_6 ,_sage_const_10 )
 L=[tan(pi*k/_sage_const_10p0 ) for k in Rango]
 p=plot(L[_sage_const_0 ]*x,(x,-_sage_const_2 ,_sage_const_2 ),show=False)
...
_st_.blockend()
try:
 _st_.plot(_sage_const_0 , format='notprovided', _p_=p.show())
except:
