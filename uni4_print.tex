...
\section{Teorema de separacin de Sturn}
...
Recordemos las distintas  soluciones generales de la  ecuación
\[y''+ay=0.\]
Ellas, acordes al valor de $a$ son
\[
y(x)=\left\{\begin{array}{l l}
    c_1e^{\sqrt{|a|}x}+c_2e^{-\sqrt{|a|}x} &\text{cuando } a<0\\
    c_1\cos(\sqrt{a}x})+c_2\sen(\sqrt{a}x) &\text{cuando } a>0\\
     c_1x+c_2 &\text{cuando } a=0\\
\end{array}
  \]
