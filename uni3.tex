...
\begin{tabular}{m{2cm} m{8cm}}
 \lstI &\hspace{-5cm}\includegraphics[scale=.2]{imagenes/sobreamortiguado.png}
\end{tabular}
...
\end{frame}
 ...
 \begin{frame}{ Vibraciones amortiguadas y forzadas ($c>0$, $F\neq 0$) } 
 Hasta aquí hemos encontrado una solución particular del sistema no homogéneo. Para encontrar una soluciíon general deberíamos  
\end{frame}
