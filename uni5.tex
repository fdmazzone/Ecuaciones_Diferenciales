...
\begin{equation}\label{eq:iter_m1}
  \begin{split}
    f(m_1+1)a_{n_0+1}&=-\sum_{k=0}^{n_0}a_k\left[p_{n_0-k}(m_2+k) + q_{n_0-k}\right]=-p_0a_{n_0}m_1-q_0\\
   f(m_1+2) a_{n_0+2}&=-\sum_{k=0}^{n_0+1}a_k\left[p_{n_0+1-k}(m_2+k) + q_{n_0+1-k}\right]\\
                   &=-p_1a_{n_0}m_1-q_1-p_0a_{n_0+1}(m_1+1)+q_0\\
                   &\,\,\,\vdots
  \end{split}
\end{equation}
