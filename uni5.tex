...
%\begin{center}
\begin{figure}[h]
\sageplot[scale=.4]{plot(J(x,1),(x,0,35))}
\caption{Función de Bessel $J_1$}
\end{figure}
%\end{center}
...
Precisamente el patrón que sigue esta sucesión es \eqref{eq:recu_bessel} con $-p$ en lugar de $p$. No obstante, la situación para la raíz $-p$ no es exactamente igual a la de la raíz $p$. La diferencia radica en, como se aprecia con claridad en \eqref{eq:recu_-p}, que cuando $p\in\frac12\mathbb{N}=\frac12,1,\frac32,\ldots$  
