...
\begin{frame}[fragile]{Cambios de variables con \textt{SymPy}}
\begin{block}{Procedimiento}
\begin{enumerate}
\item<+-> Declarar variables independientes vieja y nueva,
\item<+-> Introducir relación entre ellas
\item<+-> Declarar variable dependiente nueva, como función de variable independiente nueva.
\item<+-> Introducir relación variables dependientes
\item<+-> Introducir ecuación. 
\end{enumerate}
\end{block}
