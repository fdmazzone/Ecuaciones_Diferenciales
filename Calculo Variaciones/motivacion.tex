...
\boxedeq{L(t,\b{x},\b{y})=\sum_{i=1}^nm_i\frac{|\b{y}_i|^2}{2} - U(\b{x},\b{y})}{eq:energia_cinetica}
...
\begin{frame}{Integral de acción, principio de Hamilton}
\begin{block}{Definición}
La integral de acción depende sobre los movimientos $\b{x}(t)$, para $t$ en  un intervalo $[a,b]$,  y se define por
\boxedeq{I(\b{x})=\int_a^bL(t,\b{x}(t),\b{\dot{x}}(t))dt}{eq:integral_accion} 
\end{block}

\begin{block}{\href{https://es.wikipedia.org/wiki/Principio_de_m\%C3\%ADnima_acci\%C3\%B3n}{Principio de Mínima Acción de Hamilton}} Las soluciones de \eqref{eq:EqEuler-Lagr}
son puntos críticos  de la integral de acción. 
\end{block}
\end{frame}

\begin{frame}{Integral de acción, principio de Hamilton}
\textbf{Dem.} Como esta charla pretende dar una motivación para emprender el estudio de  
