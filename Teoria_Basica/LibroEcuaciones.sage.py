...
# This file was *autogenerated* from the file LibroEcuaciones.sage
from sage.all_cmdline import *   # import sage library

_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_325 = Integer(325); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_492 = Integer(492); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_500 = Integer(500); _sage_const_322 = Integer(322); _sage_const_345 = Integer(345); _sage_const_6 = Integer(6); _sage_const_294 = Integer(294); _sage_const_296 = Integer(296); _sage_const_0p4 = RealNumber('0.4'); _sage_const_315 = Integer(315); _sage_const_317 = Integer(317); _sage_const_352 = Integer(352); _sage_const_336 = Integer(336); _sage_const_491 = Integer(491); _sage_const_353 = Integer(353); _sage_const_338 = Integer(338); _sage_const_481 = Integer(481); _sage_const_468 = Integer(468); _sage_const_497 = Integer(497); _sage_const_p5 = RealNumber('.5'); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_p2 = RealNumber('.2'); _sage_const_30 = Integer(30); _sage_const_482 = Integer(482); _sage_const_3p0 = RealNumber('3.0'); _sage_const_476 = Integer(476); _sage_const_382 = Integer(382); _sage_const_501 = Integer(501); _sage_const_288 = Integer(288); _sage_const_384 = Integer(384); _sage_const_100 = Integer(100); _sage_const_287 = Integer(287); _sage_const_344 = Integer(344); _sage_const_471 = Integer(471); _sage_const_477 = Integer(477); _sage_const_307 = Integer(307); _sage_const_305 = Integer(305)## This file (LibroEcuaciones.sage) was *autogenerated* from the file LibroEcuaciones.tex.
import sagetex
...
_st_.blockend()
try:
 _st_.inline(_sage_const_0 , Equilibrios)
except:
...
_st_.blockend()
try:
 _st_.inline(_sage_const_2 , DLambdaX)
except:
...
_st_.blockend()
try:
 _st_.inline(_sage_const_3 , Equilibrios)
except:
...
_st_.blockend()
try:
 _st_.inline(_sage_const_9 , z_sol)
except:
...
_st_.blockend()
try:
 _st_.inline(_sage_const_10 , Sol[_sage_const_0 ])
except:
 _st_.goboom(_sage_const_500 )
try:
 _st_.inline(_sage_const_11 , Sol[_sage_const_1 ])
except:
