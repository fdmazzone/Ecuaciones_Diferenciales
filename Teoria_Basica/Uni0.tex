...
\marginpar{\includegraphics[scale=1.2]{imagenes/emacs.png}}
...
\reversemarginpar\marginpar{\Huge\faBook}
\begin{itemize}
...
\begin{pspicture}(.1in,.1in)
       \psbarcode[file]{scripts/hello.py}{raw}{qrcode}
\end{pspicture}
}
...
Python implementa diferentes tipos de datos. Para la noción de \emph{tipos de datos} en general 
