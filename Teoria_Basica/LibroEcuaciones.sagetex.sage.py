...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_325 = Integer(325); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_492 = Integer(492); _sage_const_549 = Integer(549); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_500 = Integer(500); _sage_const_322 = Integer(322); _sage_const_345 = Integer(345); _sage_const_523 = Integer(523); _sage_const_835 = Integer(835); _sage_const_22 = Integer(22); _sage_const_544 = Integer(544); _sage_const_20 = Integer(20); _sage_const_21 = Integer(21); _sage_const_836 = Integer(836); _sage_const_548 = Integer(548); _sage_const_6 = Integer(6); _sage_const_864 = Integer(864); _sage_const_18 = Integer(18); _sage_const_823 = Integer(823); _sage_const_294 = Integer(294); _sage_const_296 = Integer(296); _sage_const_822 = Integer(822); _sage_const_517 = Integer(517); _sage_const_0p4 = RealNumber('0.4'); _sage_const_315 = Integer(315); _sage_const_317 = Integer(317); _sage_const_524 = Integer(524); _sage_const_832 = Integer(832); _sage_const_538 = Integer(538); _sage_const_556 = Integer(556); _sage_const_352 = Integer(352); _sage_const_336 = Integer(336); _sage_const_555 = Integer(555); _sage_const_518 = Integer(518); _sage_const_491 = Integer(491); _sage_const_353 = Integer(353); _sage_const_338 = Integer(338); _sage_const_481 = Integer(481); _sage_const_468 = Integer(468); _sage_const_497 = Integer(497); _sage_const_p5 = RealNumber('.5'); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_16 = Integer(16); _sage_const_p2 = RealNumber('.2'); _sage_const_14 = Integer(14); _sage_const_30 = Integer(30); _sage_const_19 = Integer(19); _sage_const_482 = Integer(482); _sage_const_15 = Integer(15); _sage_const_3p0 = RealNumber('3.0'); _sage_const_476 = Integer(476); _sage_const_818 = Integer(818); _sage_const_382 = Integer(382); _sage_const_13 = Integer(13); _sage_const_501 = Integer(501); _sage_const_288 = Integer(288); _sage_const_384 = Integer(384); _sage_const_12 = Integer(12); _sage_const_100 = Integer(100); _sage_const_287 = Integer(287); _sage_const_861 = Integer(861); _sage_const_344 = Integer(344); _sage_const_471 = Integer(471); _sage_const_562 = Integer(562); _sage_const_563 = Integer(563); _sage_const_477 = Integer(477); _sage_const_307 = Integer(307); _sage_const_305 = Integer(305)## This file (LibroEcuaciones.sagetex.sage) was *autogenerated* from LibroEcuaciones.tex with sagetex.sty version 2012/01/16 v2.3.3-69dcb0eb93de.
import sagetex
_st_ = sagetex.SageTeXProcessor('LibroEcuaciones', version='2012/01/16 v2.3.3-69dcb0eb93de', version_check=True)
_st_.blockbegin()
try:
 x,y=var('x,y')
 Eq1=y
...
try:
 ...
 SolInin=solve([r.subs(t,_sage_const_0 )*cos(theta.subs(t,_sage_const_0 ))-x0\
 ,r.subs(t,_sage_const_0 )*sin(theta.subs(t,_sage_const_0 ))-y0],[k,c])
 
except:
 _st_.goboom(_sage_const_861 )
_st_.blockend()
try:
 _st_.inline(_sage_const_21 , latex(SolInin[_sage_const_0 ][_sage_const_0 ]))
except:
 _st_.goboom(_sage_const_864 )
try:
 _st_.inline(_sage_const_22 , latex((SolInin[_sage_const_0 ][_sage_const_1 ]).simplify_full()))
except:
 _st_.goboom(_sage_const_864 )
_st_.endofdoc()
