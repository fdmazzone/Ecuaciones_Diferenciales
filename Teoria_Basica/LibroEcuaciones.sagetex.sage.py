...
_sage_const_344 = Integer(344); _sage_const_345 = Integer(345); _sage_const_340 = Integer(340); _sage_const_541 = Integer(541); _sage_const_505 = Integer(505); _sage_const_500 = Integer(500); _sage_const_501 = Integer(501); _sage_const_349 = Integer(349); _sage_const_19 = Integer(19); _sage_const_18 = Integer(18); _sage_const_290 = Integer(290); _sage_const_294 = Integer(294); _sage_const_296 = Integer(296); _sage_const_548 = Integer(548); _sage_const_538 = Integer(538); _sage_const_330 = Integer(330); _sage_const_336 = Integer(336); _sage_const_338 = Integer(338); _sage_const_535 = Integer(535); _sage_const_497 = Integer(497); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_16 = Integer(16); _sage_const_15 = Integer(15); _sage_const_14 = Integer(14); _sage_const_825 = Integer(825); _sage_const_824 = Integer(824); _sage_const_820 = Integer(820); _sage_const_100 = Integer(100); _sage_const_320 = Integer(320); _sage_const_322 = Integer(322); _sage_const_325 = Integer(325); _sage_const_521 = Integer(521); _sage_const_838 = Integer(838); _sage_const_834 = Integer(834); _sage_const_837 = Integer(837); _sage_const_831 = Integer(831); _sage_const_3p0 = RealNumber('3.0'); _sage_const_551 = Integer(551); _sage_const_550 = Integer(550); _sage_const_557 = Integer(557); _sage_const_554 = Integer(554); _sage_const_485 = Integer(485); _sage_const_558 = Integer(558); _sage_const_481 = Integer(481); _sage_const_482 = Integer(482); _sage_const_p5 = RealNumber('.5'); _sage_const_p2 = RealNumber('.2'); _sage_const_803 = Integer(803); _sage_const_476 = Integer(476); _sage_const_3 = Integer(3); _sage_const_546 = Integer(546); _sage_const_492 = Integer(492); _sage_const_493 = Integer(493); _sage_const_491 = Integer(491); _sage_const_524 = Integer(524); _sage_const_477 = Integer(477); _sage_const_523 = Integer(523); _sage_const_315 = Integer(315); _sage_const_317 = Integer(317); _sage_const_313 = Integer(313); _sage_const_464 = Integer(464); _sage_const_468 = Integer(468); _sage_const_382 = Integer(382); _sage_const_384 = Integer(384); _sage_const_471 = Integer(471); _sage_const_302 = Integer(302); _sage_const_307 = Integer(307); _sage_const_305 = Integer(305); _sage_const_474 = Integer(474); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_479 = Integer(479); _sage_const_20 = Integer(20); _sage_const_0p4 = RealNumber('0.4'); _sage_const_518 = Integer(518); _sage_const_517 = Integer(517); _sage_const_353 = Integer(353); _sage_const_352 = Integer(352); _sage_const_355 = Integer(355); _sage_const_30 = Integer(30); _sage_const_288 = Integer(288); _sage_const_281 = Integer(281); _sage_const_287 = Integer(287); _sage_const_562 = Integer(562); _sage_const_564 = Integer(564); _sage_const_565 = Integer(565)## This file (LibroEcuaciones.sagetex.sage) was *autogenerated* from LibroEcuaciones.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
=======
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_325 = Integer(325); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_492 = Integer(492); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_500 = Integer(500); _sage_const_322 = Integer(322); _sage_const_345 = Integer(345); _sage_const_18 = Integer(18); _sage_const_523 = Integer(523); _sage_const_834 = Integer(834); _sage_const_20 = Integer(20); _sage_const_837 = Integer(837); _sage_const_19 = Integer(19); _sage_const_6 = Integer(6); _sage_const_824 = Integer(824); _sage_const_546 = Integer(546); _sage_const_558 = Integer(558); _sage_const_294 = Integer(294); _sage_const_296 = Integer(296); _sage_const_517 = Integer(517); _sage_const_0p4 = RealNumber('0.4'); _sage_const_550 = Integer(550); _sage_const_315 = Integer(315); _sage_const_317 = Integer(317); _sage_const_524 = Integer(524); _sage_const_538 = Integer(538); _sage_const_551 = Integer(551); _sage_const_352 = Integer(352); _sage_const_557 = Integer(557); _sage_const_336 = Integer(336); _sage_const_518 = Integer(518); _sage_const_491 = Integer(491); _sage_const_353 = Integer(353); _sage_const_338 = Integer(338); _sage_const_481 = Integer(481); _sage_const_468 = Integer(468); _sage_const_497 = Integer(497); _sage_const_p5 = RealNumber('.5'); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_16 = Integer(16); _sage_const_p2 = RealNumber('.2'); _sage_const_14 = Integer(14); _sage_const_30 = Integer(30); _sage_const_825 = Integer(825); _sage_const_482 = Integer(482); _sage_const_15 = Integer(15); _sage_const_3p0 = RealNumber('3.0'); _sage_const_476 = Integer(476); _sage_const_820 = Integer(820); _sage_const_382 = Integer(382); _sage_const_13 = Integer(13); _sage_const_501 = Integer(501); _sage_const_288 = Integer(288); _sage_const_384 = Integer(384); _sage_const_12 = Integer(12); _sage_const_100 = Integer(100); _sage_const_287 = Integer(287); _sage_const_344 = Integer(344); _sage_const_471 = Integer(471); _sage_const_838 = Integer(838); _sage_const_565 = Integer(565); _sage_const_477 = Integer(477); _sage_const_307 = Integer(307); _sage_const_564 = Integer(564); _sage_const_305 = Integer(305)## This file (LibroEcuaciones.sagetex.sage) was *autogenerated* from LibroEcuaciones.tex with sagetex.sty version 2012/01/16 v2.3.3-69dcb0eb93de.
>>>>>>> origin/master
import sagetex
...
_st_.blockbegin()
try:
 ((X(cos(b*t),sin(b*t)))[_sage_const_0 ]-(cos(b*t)).diff(t))\
 .simplify_full()
 ((X(cos(b*t),sin(b*t)))[_sage_const_1 ]-(sin(b*t)).diff(t))\
 .simplify_full()
except:
...
try:
 ...
 Eq1Pol=Eqpol[_sage_const_0 ][_sage_const_0 ].simplify_full()\
 .substitute(X==theta.diff(t))
 Eq2Pol=Eqpol[_sage_const_0 ][_sage_const_1 ].simplify_full()\
