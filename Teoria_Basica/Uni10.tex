...
\end{ejemplo}
 ...
 \begin{ejemplo}\label{ej:ejemm6.4}\emph{\cite[ Ejemplo 6.4 ]{DavidBetounes488}} Hallar matriz de mondrom´ia y multiplicadores caracter´isiticos para el sistema 2-dimensional
 \[
 \begin{array}{cc}
  x'(t)&=-x-by+x^3+xy^2\\
  y'(t)&=bx-y+x^2y+y^3
