...
\[
 ...
 \end{cases}
\]
Que es un sistema desacoplado que se puede resolver por técnicas elementales. En particular se demuestra que  $\gamma(t)=(x(t),y(t))=(\cos(b*t),\sin(b*t))$ es solución periódica de período $2\pi/b$.

Calculemos la matríz de monodromía
