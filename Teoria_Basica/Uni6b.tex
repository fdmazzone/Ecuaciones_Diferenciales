...
Por ejemplo en la \emph{Ley Enfriamiento de Newton}\index{Ley!Enfriamiento de Newton} el calor que ingresa a un cuerpo  es proporcional a la diferencia de temperatura entre el cuerpo y el medio circundante.  La ecuación se transforma
...
Para tener un problema bien panteado debemos introducir \emph{Condiciones de contorno: en $x=a$ o $x=b$} \index{Condiciones! contorno}. Hay de varios tipos
...
También debemos conocer \emph{Condiciones iniciales}\index{Condiciones!iniciales}
$$u(x,0)=f(x)$$
