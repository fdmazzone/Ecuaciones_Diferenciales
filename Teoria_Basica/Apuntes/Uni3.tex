...
\[
\frac{dr}{d\theta}=\frac{\frac{dr}{dx}}{\frac{d\theta}{dx}}=
 \frac{\left(x + y{\left (x \right )} \frac{d}{d x} y{\left (x \right )}\right) \sqrt{x^{2} + y^{2}{\left (x \right )}}}{x \frac{d}{d x} y{\left (x \right )} - y{\left (x \right )}}
\]
