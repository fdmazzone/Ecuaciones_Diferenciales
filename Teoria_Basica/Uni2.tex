...
Diremos que un grupo $G$ actúa sobre el conjunto $X$ si existe una operación binaria externa  $\star:G\times G\to G$ que satisface:
\begin{enumerate}
\item $(g_1\star g_2)\star g_3=g_1\star (g_2 \star g_3)$, para todos $g_1,g_2,g_3\in G$,
...
Sea $\Gamma_{\epsilon}$ es un grupo de Lie de simetrías de $y'=f(x,y)$. Si $y(x)$ es una curva invariante y solución de la ecuación entonces:
