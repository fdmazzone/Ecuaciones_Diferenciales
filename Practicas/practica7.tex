...
Facultad de Cs. Exactas, Físico-Químicas y Naturales\par
        ...
        Práctica 7: Teoremas de Sturm, Funciones Especiales de la Física-Matemática.
\end{scshape}
\end{bfseries}
%\end{large}
\\
...
\end{itemize}
Estudiar las secciones 44,45 y el Apéndice A del capítulo 8 de  \cite{simmons_esp} y hacer las siguientes actividades

\begin{itemize}
\item\cite[Pag. 355, Ejercicio 4]{simmons_esp}.

\item Usar SymPy para hacer los cálculos del Apéndice A, Capítulo 8 de \cite{simmons_esp}.
\end{itemize}
